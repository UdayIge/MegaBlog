...
function Login() {
    ...
    return (
        ...
        >
            <div className={`mx-auto w-full max-w-lg bg-gray-50 rounded-xl p-10 border border-black/10 transition-all duration-200 dark:bg-slate-900 dark:text-white dark:border-gray-600`}>
